...
# KNN model
new_safety_data0 <- read.table(file="final_data_0.csv", header = TRUE, na.strings=c("", "NA"), sep=",")
new_safety_data1 <- read.table(file="final_data_1.csv", header = TRUE, na.strings=c("", "NA"), sep=",")
new_safety_data2 <- read.table(file="final_data_2.csv", header = TRUE, na.strings=c("", "NA"), sep=",")
new_safety_data3 <- read.table(file="final_data_3.csv", header = TRUE, na.strings=c("", "NA"), sep=",")
new_safety_data4 <- read.table(file="final_data_4.csv", header = TRUE, na.strings=c("", "NA"), sep=",")

for(i in names(new_safety_data0)){
  new_safety_data0[[i]] <- as.numeric(new_safety_data0[[i]])
  new_safety_data1[[i]] <- as.numeric(new_safety_data1[[i]])
  new_safety_data2[[i]] <- as.numeric(new_safety_data2[[i]])
  new_safety_data3[[i]] <- as.numeric(new_safety_data3[[i]])
  new_safety_data4[[i]] <- as.numeric(new_safety_data4[[i]])
}
...
new_train0 <- new_safety_data0[1:(new_train_ind-1),]
new_val0 <- new_safety_data0[(new_train_ind):(new_val_ind),]
new_test0 <- new_safety_data0[(new_val_ind+1):nrow(new_safety_data0),]

new_train1 <- new_safety_data1[1:(new_train_ind-1),]
new_val1 <- new_safety_data1[(new_train_ind):(new_val_ind),]
new_test1 <- new_safety_data1[(new_val_ind+1):nrow(new_safety_data1),]

new_train2 <- new_safety_data0[1:(new_train_ind-1),]
new_val2 <- new_safety_data0[(new_train_ind):(new_val_ind),]
new_test2 <- new_safety_data0[(new_val_ind+1):nrow(new_safety_data2),]

new_train3 <- new_safety_data0[1:(new_train_ind-1),]
new_val3 <- new_safety_data0[(new_train_ind):(new_val_ind),]
new_test3 <- new_safety_data0[(new_val_ind+1):nrow(new_safety_data3),]

new_train4 <- new_safety_data0[1:(new_train_ind-1),]
new_val4 <- new_safety_data0[(new_train_ind):(new_val_ind),]
new_test4 <- new_safety_data0[(new_val_ind+1):nrow(new_safety_data4),]

train_use0 <- subset(new_train0, select=-point_security)
val_use0 <- subset(new_val0, select=-point_security)
test_use0 <- subset(new_test0, select=-point_security)

train_use1 <- subset(new_train1, select=-point_security)
val_use1 <- subset(new_val1, select=-point_security)
test_use1 <- subset(new_test1, select=-point_security)

train_use2 <- subset(new_train2, select=-point_security)
val_use2 <- subset(new_val2, select=-point_security)
test_use2 <- subset(new_test2, select=-point_security)

train_use3 <- subset(new_train3, select=-point_security)
val_use3 <- subset(new_val3, select=-point_security)
test_use3 <- subset(new_test3, select=-point_security)

train_use4 <- subset(new_train4, select=-point_security)
val_use4 <- subset(new_val4, select=-point_security)
test_use4 <- subset(new_test4, select=-point_security)
